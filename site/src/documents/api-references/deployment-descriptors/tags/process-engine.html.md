...
<table class="table table-striped">
  ...
  <tr>
    ...
    <td>
      ...
      <p>
        <strong>Text Content:</strong>
        the fully qualified classname of the Process Engine Configuration class to use for this process engine. The class must be a subclass of <a href="ref:/reference/javadoc/?org/camunda/bpm/engine/impl/cfg/ProcessEngineConfigurationImpl.html">ProcessEngineConfigurationImpl</a>.
      </p>
      <p>
