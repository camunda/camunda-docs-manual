...
Query for jobs that fulfill given parameters. This method is slightly more powerful than the [GET query](ref:#job-get-jobs), because it allows to filter by multiple jobs of types `String`, `Number` or `Boolean`.
