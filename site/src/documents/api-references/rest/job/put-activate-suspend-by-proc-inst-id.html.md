...
<table class="table table-striped">
  ...
  <tr>
    <td>suspended</td>
    <td>A <code>Boolean</code> value which indicates whether to activate or suspend all jobs with the given process instance id. When the value is set to <code>true</code>, then all jobs with the given process instance id will be suspended and when the value is set to <code>false</code>, then all jobs with the given process instance id will be activated.</td>
  </tr>
</table>
