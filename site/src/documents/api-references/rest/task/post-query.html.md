...
<table class="table table-striped">
  ...
  <tr>
    ...
    <td>
      ...
      but no `sortBy` or if an invalid operator for variable comparison is used. See the [Introduction](/api-references/rest/#!/overview/introduction) for the error response format.
    </td>
  </tr>
</table>
