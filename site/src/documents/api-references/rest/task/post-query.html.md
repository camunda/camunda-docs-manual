...
This method is slightly more powerful than the <a href="#!/task/get-query" doc-location-highlight>GET query</a>, because it allows
...
<a href="#!/task/post-query-count" doc-location-highlight>get tasks count (POST)</a> method.
...
<table class="table table-striped">
  ...
  <tr>
    ...
    <td>
      ...
      but no `sortBy` or if an invalid operator for variable comparison is used. See the <a href="/api-references/rest/#!/overview/introduction">Introduction</a> for the error response format.
    </td>
  </tr>
</table>
