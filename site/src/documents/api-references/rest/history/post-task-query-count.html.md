...
Takes the same parameters as the [get historic tasks](ref:#history-get-task-historic) method.
Corresponds to the size of the result set of the [get tasks (POST)](ref:#history-get-task-historic-post) method and takes the same parameters.
