Get Historic Process Instances (POST)
=============

Query for historic process instances that fulfill the given parameters. 
This method is slightly more powerful than the <a href="#!/history/get-process-instance-query" doc-location-highlight>GET query</a>, because it allows to filter by multiple process variables of types `String`, `Number` or `Boolean`.
