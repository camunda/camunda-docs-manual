...
<table class="table">
  <thead>
	...
	<tr class="well">
      ...
      <td>
        <a class="btn btn-sm btn-default" href="ref:asset:/assets/pdf/administratorenhandbuch-camunda-web-modeler-version-86.pdf" target="_blank">download pdf (German)</a>
      </td>
  	</tr>
	<tr>
      <td>7.8.0.1</td>
