...
See above, how to [install the pre-built distro](#platform) or [install the platform on a vanilla Glassfish](#vanilla).
Furthermore, to be able to use camunda cockpit the REST API has to be [installed on Glassfish](#rest) too.
...
See above, how to [install the pre-built distro](#platform) or [install the platform on a vanilla Glassfish](#vanilla).
Furthermore, to be able to use camunda tasklist the REST API has to be [installed on Glassfish](#rest) too.
