...
<table class="table">
  ...
  <tbody>
    <tr>
      <td>Apache Tomcat</td>
      <td>
        <a href="//camunda.org/release/camunda-bpm/tomcat/7.7/camunda-webapp-tomcat-standalone-7.7.0.war">
    ...
    <tr>
      <td>JBoss AS 7</td>
      <td>
        <a href="//camunda.org/release/camunda-bpm/jboss/7.7/camunda-webapp-jboss-standalone-7.7.0.war">
