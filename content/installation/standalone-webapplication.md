...
<table class="table">
  ...
  <tbody>
    <tr>
      <td>Apache Tomcat</td>
      <td>
        <a href="//camunda.org/release/camunda-bpm/tomcat/7.5/camunda-webapp-tomcat-standalone-7.5.0.war">
          camunda-webapp-tomcat-standalone-7.5.0.war
        </a>
      </td>
    </tr>
    <tr>
      <td>JBoss AS 7</td>
      <td>
        <a href="//camunda.org/release/camunda-bpm/jboss/7.5/camunda-webapp-jboss-standalone-7.5.0.war">
          camunda-webapp-jboss-standalone-7.5.0.war
        </a>
      </td>
    </tr>
    <tr>
