...
<table class="table">
  ...
  <tbody>
    <tr>
      <td>Apache Tomcat</td>
      <td>
        <a href="//camunda.org/release/camunda-bpm/tomcat/7.4/camunda-webapp-tomcat-standalone-7.4.0.war">
          camunda-webapp-tomcat-standalone-7.4.0.war
        </a>
      </td>
    </tr>
    <tr>
      <td>JBoss AS 7</td>
      <td>
        <a href="//camunda.org/release/camunda-bpm/jboss/7.4/camunda-webapp-jboss-standalone-7.4.0.war">
          camunda-webapp-jboss-standalone-7.4.0.war
        </a>
      </td>
    </tr>
    <tr>
