...
Download a Camunda Cycle from our [NEXUS repository](https://artifacts.camunda.com/artifactory/public/org/camunda/bpm/cycle/camunda-cycle-tomcat/). Choose the correct version named `$CYCLE_VERSION/camunda-cycle-tomcat-$CYCLE_VERSION.war`.


## Database Scripts

Download scripts to create the database schema from our [NEXUS repository](https://artifacts.camunda.com/artifactory/public/org/camunda/bpm/cycle/camunda-cycle-sql-scripts/). Choose the correct version named `$CYCLE_VERSION/camunda-cycle-sql-scripts-$CYCLE_VERSION.jar`.
...
{{< note title="" class="info" >}}
  If you have not got the distro at hand, you can also download a file that packages these scripts from our [server](https://artifacts.camunda.com/artifactory/public/org/camunda/bpm/cycle/camunda-cycle-sql-scripts/).
...
You can download the Camunda Cycle web application from our [server](https://artifacts.camunda.com/artifactory/public/org/camunda/bpm/cycle/camunda-cycle-tomcat/).
...
{{< note title="" class="info" >}}
  If you have not got the distro at hand, you can also download a file that packages these scripts from our [server](https://artifacts.camunda.com/artifactory/public/org/camunda/bpm/cycle/camunda-cycle-sql-scripts/3.1.0/camunda-cycle-sql-scripts-3.1.0.jar).
{{< /note >}}
