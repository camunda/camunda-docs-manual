...
1. Download the pre-packaged distribution for JBoss AS 7 from https://downloads.camunda.cloud/release/camunda-bpm/jboss/, for Wildfly from https://downloads.camunda.cloud/release/camunda-bpm/wildfly/.
