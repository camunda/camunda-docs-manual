...
First, you need to download the [Camunda WildFly distribution](https://downloads.camunda.cloud/release/camunda-bpm/wildfly/) and the [Camunda WildFly 8 Modules (camunda-wildfly8-modules)](https://artifacts.camunda.com/artifactory/public/org/camunda/bpm/wildfly/camunda-wildfly8-modules/) archive if you're using WildFly 8.
