...
Provided a valid license file under `${user.home}/.camunda/license.txt`, Camunda Platform Run will automatically pick it up and use it to unlock the enterprise features.
