...
Depending on whether you have defined a [start form]({{< relref "user-guide/task-forms/index.md" >}}) for your process it will be displayed now. Otherwise you get a notification that no form has been defined for starting the process. In this case, a [generic start form]({{< relref "user-guide/task-forms/generic.md" >}}) will be displayed and Tasklist will offer the option of adding variables to the process instance.
