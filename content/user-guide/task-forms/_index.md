...
Embedded task forms are HTML and JavaScript forms which can be displayed directly inside the tasklist. We provide more information about the creation of embedded forms in our [Embedded Task Forms Reference]({{< ref "/reference/embedded-forms/_index.md" >}}).
...
{{< note title="How To" class="info" >}}
  [How to add JSF Forms to your process application]({{< ref "/examples/tutorials/jsf-task-forms.md" >}})
{{< /note >}}
...
[jsf-task-forms]: {{< ref "/examples/tutorials/jsf-task-forms.md" >}}
