...
* The inheritance from AssertJ's `Assertions` has been cut. In case AssertJ assertions are used in test code besides Camunda Platform Assert assertions, the imports have to be adjusted to also include:
