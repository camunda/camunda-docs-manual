...
In addition to the decision definitions, the [decision requirements graph]({{< ref "/reference/dmn11/drg/_index.md" >}}) (i.e., the `definitions` element in the XML) of a deployed DMN resource is transformed into a *Decision Requirements Definition*. It has, among others, these attributes:
