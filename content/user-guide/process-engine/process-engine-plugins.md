...
* in the [Camunda 7 Deployment Descriptors]({{< ref "/reference/deployment-descriptors/_index.md" >}}) (bpm-platform.xml/processes.xml),
...
* in the [Camunda 7 Run YAML configuration files]({{< ref "/user-guide/camunda-bpm-run.md#process-engine-plugin-registration" >}})
* programatically.
