...
Alternatively, you can use the  [bpmn-viewer widget](https://github.com/camunda/camunda-bpm-webapp/blob/master/camunda-commons-ui/lib/widgets/bpmn-viewer/cam-widget-bpmn-viewer.html) from the Camunda commons UI.
