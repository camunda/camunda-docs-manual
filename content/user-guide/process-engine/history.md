...
```
Also available via [REST API]({{< ref "/reference/rest/history/post-history-cleanup.md">}}).
...
* Manually set the number of retries to >0 for the history cleanup job (e.g., via the [REST API]({{< ref "/reference/rest/job/put-set-job-retries.md">}})) 
