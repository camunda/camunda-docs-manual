...
If variables being fetched are serialized it is necessary to call `deserializeVariables(true)` method. Otherwise an IllegalStateException is thrown once the serialized variable is retrieved from the variables map.
