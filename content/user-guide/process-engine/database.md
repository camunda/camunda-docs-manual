...
{{< img src="../img/erd_oracle_73_cmmn.svg" title="CMN Tables" >}}
...
{{< img src="../img/erd_oracle_73_history.svg" title="History Tables" >}}


## Identity

{{< img src="../img/erd_oracle_73_identity.svg" title="Identity Tables" >}}
...
Note that internally the engine uses [Apache MyBatis](http://www.mybatis.org/) for persistence.
...
* `jdbcStatementTimeout`: The amount of time in seconds the jdbc driver will wait for a response from the database. Default is null that means there is no timeout.
...
{{< note title="Suported Databases" class="warning" >}}
  For information on supported databases please refer to <a href="ref:#introduction-supported-environments"> [Supported Environments]({{< relref "user-guide/introduction/supported-environments.md#databases" >}})
{{< /note >}}
