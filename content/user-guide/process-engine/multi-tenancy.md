...
* **Via JNDI on JBoss/Wildfly**: On JBoss and Wildfly, every container-managed process engine can be [looked up via JNDI]({{< relref "user-guide/runtime-container-integration/the-camunda-jboss-as-7-subsystem.md#looking-up-a-process-engine-in-jndi" >}}).
