...
Please make sure to configure the properties together with the prefix: `org.camunda.bpm.client`
...
The properties for topic subscriptions go under: `org.camunda.bpm.client.subscriptions`
