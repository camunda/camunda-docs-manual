...
## 7.15.9 to 7.15.10 / 7.14.15 to 7.14.16
...
## 7.15.16 to 7.15.17 / 7.15.18

The 7.15.17 release contains a regression in Cockpit where DMN diagrams are not or only partially rendered. Please don't use this patch release unless you know what you are doing. The 7.15.18 release contains a fix for this regression.
...
The Camunda Platform 7.15.19 release removes the H2 console application from the Tomcat and WildFly distributions. There will not be any further releases of the Camunda H2 console web app going forward.
