...
<table class="table desc-table">
  ...
  <tbody>
    ...
    <tr>
      <td>7.5</td>
      <td>engine_7.5_patch_7.5.8_to_7.5.9.sql</td>
      <td>Add missing foreign key to prevent inconsistent data.</td>
      <td>All databases</td>
      <td><a href="https://app.camunda.com/jira/browse/CAM-7477">CAM-7477</a></td>
    </tr>
    <tr>
      <td>7.6</td>
    ...
    <tr>
      <td>7.6</td>
      <td>engine_7.6_patch_7.6.7_to_7.6.8.sql</td>
      <td>Add missing foreign key to prevent inconsistent data. <strong>This is the same patch as engine_7.5_patch_7.5.8_to_7.5.9.sql</strong>.</td>
      <td>All databases</td>
      <td><a href="https://app.camunda.com/jira/browse/CAM-7477">CAM-7477</a></td>
    </tr>    
    <tr>
      <td>7.7</td>
      <td>engine_7.7_patch_7.7.1_to_7.7.2.sql</td>
      <td>Add missing foreign key to prevent inconsistent data. <strong>This is the same patch as engine_7.5_patch_7.5.8_to_7.5.9.sql and engine_7.6_patch_7.6.7_to_7.6.8.sql</strong>.</td>
      <td>All databases</td>
      <td><a href="https://app.camunda.com/jira/browse/CAM-7477">CAM-7477</a></td>
    </tr>    
  </tbody>
