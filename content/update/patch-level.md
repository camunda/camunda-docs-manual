...
With 7.16.9, and 7.15.15, Alpine, the base image in Camunda’s Docker images, has been updated from version 3.13 to 3.15.
...
## 7.16.10 to 7.16.11 / 7.16.12

The 7.16.11 release contains a regression in Cockpit where DMN diagrams are not or only partially rendered. Please don't use this patch release unless you know what you are doing. The 7.16.12 release contains a fix for this regression.
