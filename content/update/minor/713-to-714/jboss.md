...
already done, make sure to download the [Camunda BPM 7.14 JBoss distribution](https://downloads.camunda.cloud/release/camunda-bpm/jboss/7.14/)
or [Camunda BPM 7.14 Wildfly distribution](https://downloads.camunda.cloud/release/camunda-bpm/wildfly/7.14/). In the following instructions
