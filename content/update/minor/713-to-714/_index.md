...
You can enable the old behavior by overriding the JQuery `htmlPrefilter` function using a custom script. We provide an example for tasklist [here](https://github.com/camunda/camunda-bpm-examples/tree/master/cockpit/jquery-34-behaviour). Please keep in mind that this will reintroduce a security voulnerability that was fixed by this update.

You can reed more about the update in the [JQuery release blog](https://blog.jquery.com/2020/04/10/jquery-3-5-0-released/)