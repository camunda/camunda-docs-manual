...
2. For administrators and developers: [Database Updates](#database-updates)
...
5. For developers: [Update to JQuery 3.5](#update-to-jquery-3-5)
6. For developers: [Changes to Task Query and Historic Task Query behavior](#changes-to-task-query-and-historic-task-query-behavior)
7. For developers: [New Engine Dependency - Connect](#new-engine-dependency-connect)
8. For developers: [Changes to the Cockpit Config File](#changes-to-the-cockpit-config-file)
9. For developers: [New Frontend Plugin System for Cockpit](#new-frontend-plugin-system-for-cockpit)
10. For developers: [End of Spring 3 Support](#end-of-spring-3-support)
11. For developers: [New Process Engine Property](#new-process-engine-property)
12. For developers: [Disable Telemetry Reporter in Tests](#disable-telemetry-reporter-in-tests)
13. For administrators and developers: [PostgreSQL Support Clarification](#postgresql-support-clarification)
