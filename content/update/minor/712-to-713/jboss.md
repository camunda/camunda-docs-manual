...
already done, make sure to download the [Camunda Platform 7.13 JBoss distribution](https://downloads.camunda.cloud/release/camunda-bpm/jboss/7.13/)
or [Camunda Platform 7.13 Wildfly distribution](https://downloads.camunda.cloud/release/camunda-bpm/wildfly/7.13/). In the following instructions
...
[engine-rest]: https://app.camunda.com/nexus/service/rest/repository/browse/camunda-bpm/org/camunda/bpm/camunda-engine-rest/7.13.0/
[webapp-jboss]: https://app.camunda.com/nexus/repository/camunda-bpm/org/camunda/bpm/webapp/camunda-webapp-jboss/7.13.0/camunda-webapp-jboss-7.13.0.war
