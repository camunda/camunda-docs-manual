...
already done, make sure to download the [Camunda 7.13 JBoss distribution](https://downloads.camunda.cloud/release/camunda-bpm/jboss/7.13/)
or [Camunda 7.13 Wildfly distribution](https://downloads.camunda.cloud/release/camunda-bpm/wildfly/7.13/). In the following instructions
