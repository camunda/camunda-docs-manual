...
This document guides you through the update from Camunda 7 `7.12.x` to `7.13.0`. It covers these use cases:
...
The library version has therefore changed from Camunda Spring Boot Starter (currently at 3.4.x) to Camunda 7 version (7.13.0).
