...
already done, make sure to download the [Camunda BPM 7.6 JBoss distribution](http://downloads.camunda.cloud/release/camunda-bpm/jboss/7.6/), [Camunda BPM 7.6 Wildfly 8](http://downloads.camunda.cloud/release/camunda-bpm/wildfly8/7.6/)
or [Camunda BPM 7.6 Wildfly 10 distribution](http://downloads.camunda.cloud/release/camunda-bpm/wildfly10/7.6/). In the following instructions
