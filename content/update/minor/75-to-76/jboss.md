...
already done, make sure to download the [Camunda Platform 7.6 JBoss distribution](https://downloads.camunda.cloud/release/camunda-bpm/jboss/7.6/), [Camunda Platform 7.6 Wildfly 8](https://downloads.camunda.cloud/release/camunda-bpm/wildfly8/7.6/)
or [Camunda Platform 7.6 Wildfly 10 distribution](https://downloads.camunda.cloud/release/camunda-bpm/wildfly10/7.6/). In the following instructions
