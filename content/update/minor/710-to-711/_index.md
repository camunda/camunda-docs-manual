...
5. For developers: [camunda-engine-spring Update](#camunda-engine-spring-update)
6. For developers: [External Task Client Update](#external-task-client-update)
7. For developers: [Changes Affecting Custom Permissions/Resources](#changes-affecting-custom-permissions-resources)
8. For administrators and developers: [User Operation Log Permissions](#user-operation-log-permissions)
9. For developers: [Custom WritableIdentityProvider](#custom-writableidentityprovider)
10. For developers: [Exception Handling in Processes](#exception-handling-in-processes)
11. For developers: [Updated Front End Libraries](#updated-front-end-libraries)
12. For developers: [HTTP Header Security in Webapps](#http-header-security-in-webapps)
