...
already done, make sure to download the [Camunda BPM 7.7 JBoss distribution](http://downloads.camunda.cloud/release/camunda-bpm/jboss/7.7/), [Camunda BPM 7.7 Wildfly 8](http://downloads.camunda.cloud/release/camunda-bpm/wildfly8/7.7/)
or [Camunda BPM 7.7 Wildfly 10 distribution](http://downloads.camunda.cloud/release/camunda-bpm/wildfly10/7.7/). In the following instructions
