...
already done, make sure to download the [Camunda BPM 7.12 JBoss distribution](http://camunda.org/release/camunda-bpm/jboss/7.12/)
or [Camunda BPM 7.12 Wildfly distribution](http://camunda.org/release/camunda-bpm/wildfly/7.12/). In the following instructions
