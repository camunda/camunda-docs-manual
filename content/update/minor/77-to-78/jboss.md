...
already done, make sure to download the [Camunda 7.8 JBoss distribution](https://downloads.camunda.cloud/release/camunda-bpm/jboss/7.8/), [Camunda 7.8 Wildfly 8](https://downloads.camunda.cloud/release/camunda-bpm/wildfly8/7.8/)
or [Camunda 7.8 Wildfly 10 distribution](https://downloads.camunda.cloud/release/camunda-bpm/wildfly10/7.8/). In the following instructions
