...
already done, make sure to download the [Camunda BPM 7.8 JBoss distribution](http://downloads.camunda.cloud/release/camunda-bpm/jboss/7.8/), [Camunda BPM 7.8 Wildfly 8](http://downloads.camunda.cloud/release/camunda-bpm/wildfly8/7.8/)
or [Camunda BPM 7.8 Wildfly 10 distribution](http://downloads.camunda.cloud/release/camunda-bpm/wildfly10/7.8/). In the following instructions
