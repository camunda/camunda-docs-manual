...
already done, make sure to download the [Camunda 7.9 JBoss distribution](https://downloads.camunda.cloud/release/camunda-bpm/jboss/7.9/), [Camunda 7.9 Wildfly 8](https://downloads.camunda.cloud/release/camunda-bpm/wildfly8/7.9/)
or [Camunda 7.9 Wildfly 10 distribution](https://downloads.camunda.cloud/release/camunda-bpm/wildfly10/7.9/). In the following instructions
