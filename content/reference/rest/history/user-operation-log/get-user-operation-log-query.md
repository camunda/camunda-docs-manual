...
The size of the result set can be retrieved by using the [count]({{< ref "/reference/rest/history/user-operation-log/get-user-operation-log-query-count.md" >}}) method.
