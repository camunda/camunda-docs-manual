...
This method is slightly more powerful than the [GET query]({{< ref "/reference/rest/history/job-log/get-job-log-query.md" >}}) because it allows filtering by historic job logs values of the different types `String`, `Number` or `Boolean`.
