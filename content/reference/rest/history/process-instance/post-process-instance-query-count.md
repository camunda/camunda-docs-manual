...
This method takes the same message body as the [POST query]({{< ref "/reference/rest/history/process-instance/post-process-instance-query.md" >}}) and therefore it is slightly more powerful than the [GET query count]({{< ref "/reference/rest/history/process-instance/get-process-instance-query-count.md" >}}).
