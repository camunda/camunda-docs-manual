...
<table class="table table-striped">
  ...
  <tr>
    <td>finished</td>
    <td>Only include finished process instances. Value may only be <code>true</code>, as <code>false</code> is the default behavior. This flag includes all process instances that are completed or terminated</td>
  </tr>
  <tr>
    <td>unfinished</td>
