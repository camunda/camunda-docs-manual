...
This method is slightly more powerful than the [GET query]({{< ref "/reference/rest/history/variable-instance/get-variable-instance-query.md" >}}) because it allows filtering by variable values of the different types `String`, `Number` or `Boolean`.
