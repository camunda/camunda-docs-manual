...
The size of the result set can be retrieved by using the [count]({{< ref "/reference/rest/history/variable-instance/get-variable-instance-query-count.md" >}}) method.
