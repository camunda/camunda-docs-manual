...
This method is slightly more powerful than the [GET query]({{< ref "/reference/rest/external-task/get-query.md" >}}) because it allows to specify a hierarchical result sorting.
