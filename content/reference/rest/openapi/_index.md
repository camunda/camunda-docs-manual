...
[OpenAPI Specification 3.0.2][spec-3.0.2]:
...
The OpenAPI documentation brings options for:
...
Download the Camunda REST API artifact containing the OpenAPI documentation [here][nexus-link].
...
The documentation is not complete, and it contains only the endpoints for the resources listed below:
