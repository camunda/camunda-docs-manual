...
Query for variable instances that fulfill given parameters. Parameters may be the properties of variable instances, such as the name or type. The size of the result set can be retrieved by using the [get variable instances count]({{< ref "/reference/rest/variable-instance/get-query-count.md" >}}) method.
