...
DELETE `/process-definition/key/invoice?cascade=true&skipCustomListeners=true`

DELETE `/process-definition/key/invoice/tenant-id/tenant1?cascade=true&skipCustomListeners=true`
