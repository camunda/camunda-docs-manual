...
Retrieves the start form variables for a process definition (only if they are defined via the [Generated Task Form]({{< ref "/user-guide/task-forms/_index.md#generated-task-forms" >}}) approach).
