...
<table class="table table-striped">
  ...
  <tr id="initializeTelemetry">
    ...
    <td>
        ...
        <p>
          Before you install version alpha 7.14 Alpha 1 or activate the telemetric functionality, please make sure that you are authorized to take this step, and that the installation or activation of the telemetric functionality is not in conflict with any internal company policies, compliance guidelines, any contractual or other provisions or obligations of your company.
        </p>
        <p>
