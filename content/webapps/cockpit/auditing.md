...
While this log can currently not be viewed in Cockpit's UI, there are existing [Java and REST API methods]({{< ref "/user-guide/process-engine/history.md#accessing-the-user-operation-log" >}}) to perform this task.
...
<table class="table table-striped">
  ...
  <tr>
    <td><a href="{{< ref "/webapps/cockpit/bpmn/failed-jobs.md#bulk-retry" >}}">Bulk Retry of Failed Jobs</a></td>
    <td>SetJobRetries</td>
    <td>Job</td>
  </tr>
  <tr>
